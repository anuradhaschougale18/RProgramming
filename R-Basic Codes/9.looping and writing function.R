...
## for loop 
#it is used when iteration is required thorugh a list
# For numeric vector
for(i in (1:10)-3){
  print(c(i,i*i))
}
...
#as long ass a specific condition is met#
i<-2.999
...
## repeat loop
##the repeat loop is an infinte loop and used in 
...
## a break statement is used in a loop to stoop 
#the iterations and flow the control outside 
#of the loop
